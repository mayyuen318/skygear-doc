  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Skygear Docs got guides, API reference and sample projects to help developers get started. All iOS, Android & JS basics you need to know to add backend features." />
        <meta property="og:url"                content="https://docs.skygear.io/" />
        <meta property="og:title"              content="Documentations - Skygear" />
        <meta property="og:description"        content="Skygear Docs got guides, API reference and sample projects to help developers get started. All iOS, Android & JS basics you need to know to add backend features." />
